      ...
      <section className="hero">
        ...
        <motion.div className="hero-content">
          <span className="hero-badge">
            <img src={logoImg} alt="Hackathon Logo" className="badge-image" />
          </span>


          <h1><span>KreativeGenesis Hackathon 2026</span></h1>
          <h2>National Level 24-Hour Innovation Hackathon</h2>
        ...
        <div className="carousel-container">
          ...
          <div className="carousel-wrapper">
            <motion.div
              ...
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 1.2 }}   // slow smooth fade
            >
              <img
